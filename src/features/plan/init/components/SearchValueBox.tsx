...
export default function SearchValueBox({
  ...
  if (isLoading) {
    return (
      <>
      {isShow && <div className="grid grid-cols-2 top-[4rem] w-full border rounded-2xl shadow-sm bg-white p-3 z-30 gap-3 absolute">
            ...
            data.map((item, index) => {
              ...
              return (
                <Card
                  ...
                  onClick={() => setDestination(() => exist? "": item.destination)}
                >
